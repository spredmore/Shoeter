...
namespace Shoeter
{
	...
	class MessageBoxScreen : GameScreen
	{
		...
		public MessageBoxScreen(string message, bool useMainMenuExitText)
		{
			if (useMainMenuExitText)
			{
		...
		public override void Draw(GameTime gameTime)
		{
			...
			SpriteFont font = ScreenManager.DialogBoxFont;
			...
			spriteBatch.DrawString(font, message, textPosition, Color.Tomato);
